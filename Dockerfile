...
# docker build -t eb1104:0.0.0.9001 .
...
# docker run --name eb1104_c --net r-db -e PASSWORD=eb1104 -p 8787:8787 -v $(pwd):/home/rstudio/eb1104 eb1104:0.0.0.9001
